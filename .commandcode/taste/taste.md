...
# workflow
- Do not commit generated analysis/audit markdown files (e.g., FRONTEND_BUGS_ANALYSIS.md, IMPLEMENTATION_PLAN.md) to the repository — they are ephemeral working documents. Confidence: 0.70
