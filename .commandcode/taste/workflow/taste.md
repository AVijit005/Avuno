...
- Never make definitive readiness assessments ("beta-ready", "SaaS-ready", "production-ready") without first independently verifying all claimed criteria — do not assert a status and only check after the user challenges it; verify first, then report. Confidence: 0.70
