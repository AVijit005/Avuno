...
**Rule:** A Memory *MUST* be created through explicit user action. No AI generation, no detached synthesis. If a Memory is created from a Journal or Quote, it must reference it (journalId or quoteId). The backend enforces this.
