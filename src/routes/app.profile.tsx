...
function ProfilePage() {
  ...
  return (
    <div className="pt-2 pb-20">
      ...
      <PullQuote attribution="Memora · a living record">
      ...
      <Section title="Memory map" subtitle="Every corner of your Memora, one tap away.">
        <MemoryMap />
      </Section>
        ...
        <SplitBlock
          ...
          secondary={
            <div className="pt-2">
              ...
              <p className="mt-4 max-w-prose text-[15px] leading-relaxed text-foreground/80">
                Weekends and weeks Memora quietly folded into a single feeling — opened only when
                you want them.
              </p>
            </div>
          }
