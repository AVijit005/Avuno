                ...
                >
                  ...
                  <div className="pt-2">
                    <PremiumButton
                      ...
                      icon={status === "idle" || status === "error" ? <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" /> : undefined}
                    >
  ...
  return (
    <div className="relative flex w-full rounded-[14px] bg-foreground/[0.04] border border-foreground/[0.08] p-1">
      ...
      <button
        ...
        className={cn("relative z-10 w-1/2 rounded-[10px] py-2 text-xs font-medium transition-colors", mode === "signin" ? "text-foreground" : "text-muted-foreground hover:text-foreground")}
      >
        Sign in
      </button>
      <button
        ...
        className={cn("relative z-10 w-1/2 rounded-[10px] py-2 text-xs font-medium transition-colors", mode === "signup" ? "text-foreground" : "text-muted-foreground hover:text-foreground")}
      >
        Create Account
      </button>
    </div>
...
function PasswordStrength({ strength }: { strength: number }) {
  ...
  const segmentColor = strength <= 2 ? "bg-destructive" : strength <= 3 ? "bg-amber-500" : "bg-primary";
