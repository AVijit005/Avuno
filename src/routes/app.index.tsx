  ...
  head: () => ({
    meta: [
      { title: "Dashboard — Avuno" },
      {
        name: "description",
        content:
          "Your personal media headquarters. Continue stories, track progress, and discover what to watch next.",
      },
...
const QUOTES = [
  {
    ...
    attr: "Your weekly reflection",
  },
  {
    quote: "The stories we return to say more about us than the stories we finish.",
    attr: "Your taste profile",
  },
  {
    quote: "Memory isn't about perfect recall. It's about what chooses to stay.",
    attr: "From your journal",
  },
  {
    quote: "Every library is a self-portrait painted in other people's stories.",
    attr: "A quiet thought",
  },
];
...
function Home() {
  ...
  return (
    <div className="pt-2">
      {featuredItem ? (
        <CinematicHero item={featuredItem} />
      ) : (
        <div className="glass-strong rounded-b-[40px] p-16 text-center">
          <p className="text-muted-foreground">
            Add some media to your library to see your dashboard come alive.
          </p>
        </div>
      )}
      ...
      {isNewUser ? (
        ...
        <>
          <ErrorBoundary
            fallback={
              <div className="p-4 text-sm text-muted-foreground text-center">
                Failed to load interactive widgets.
              </div>
            }
          >
            <InteractiveWidgets />
          ...
          >
            <div className="mt-16 pointer-events-auto">
              <PremiumGlass
                interactive
                variant="strong"
                glow="oklch(0.72 0.18 255 / 0.2)"
                className="group/master rounded-[2.5rem]"
              >
                <div className="flex flex-col text-left p-10 w-full">
                  <div>
                    ...
                    <p className="mt-4 text-[15px] leading-relaxed text-foreground/80">
                      Not metrics — moods. The shape of how you've been spending your stories this
                      month. Look softly. Nothing here demands a goal.
                    </p>
                  </div>
          ...
          <ErrorBoundary
            fallback={
              <div className="p-4 text-sm text-muted-foreground text-center">
                Completed items failed to load.
              </div>
            }
          >
  ...
  const STEPS = [
    {
      ...
      description:
        "Search for any movie, book, game, or show and add it to your library. That's how Avuno starts knowing you.",
      icon: Plus,
      action: "Open library",
      to: "/app/library",
    },
    {
      ...
      description: "Capture a thought about what you watched. Even one sentence starts a memory.",
      icon: NotebookPen,
      action: "Open journal",
      to: "/app/journal",
    },
    {
      ...
      description:
        "See your year mapped out — every story, every quiet evening arranged into a timeline.",
      icon: Calendar,
  ...
  return (
    <div className="mt-10 space-y-10">
      <div className="text-center">
        <h2 className="font-display text-4xl tracking-tight md:text-5xl">Welcome to Avuno</h2>
