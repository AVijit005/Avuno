...
function OnboardingGuide() {
  ...
  const STEPS = [
    { number: "01", title: "Add your first story", description: "Search for any movie, book, game, or show and add it to your library. That's how Avuno starts knowing you.", icon: Plus, action: "Open library", to: "/app/library" },
