    ...
    <div className="min-h-screen bg-[oklch(0.08_0.02_270)] py-20 px-4 md:px-8 text-white flex flex-col items-center justify-center">
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="prose prose-invert max-w-none text-white/80 space-y-6">
          <p>
            Please read these Terms of Service carefully before using Avuno (the "Service"). By
          ...
          <p>
            Some parts of the Service are billed on a subscription basis ("Subscriptions"). You will
            be billed in advance on a recurring and periodic basis (such as monthly or annually). By
            purchasing a Subscription, you authorize us to charge the applicable fees to your
            payment method.
          </p>
          ...
          <p>
            ...
            information, text, or graphics ("Content"). You retain all of your ownership rights in
            your Content. By posting Content, you grant us the right to store and process it solely
            to provide the Service to you.
          </p>
          <p>
            You may not upload Content that is illegal, infringes on intellectual property rights,
            or is otherwise harmful or offensive. We reserve the right to remove any Content that
          ...
          <p>
            ...
            functionality are and will remain the exclusive property of Avuno and its licensors.
          </p>
          ...
          <p>
            In no event shall Avuno, nor its directors, employees, partners, agents, suppliers, or
