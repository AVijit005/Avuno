    ...
    <div className="min-h-screen bg-[oklch(0.08_0.02_270)] py-20 px-4 md:px-8 text-white flex flex-col items-center justify-center">
      <div className="max-w-3xl w-full space-y-8">
        ...
        <div className="prose prose-invert max-w-none text-white/80 space-y-6">
          <p>
            Avuno ("we", "our", or "us") is committed to protecting your privacy. This Privacy
          ...
          <p>
            ...
            address, name, and authentication credentials. If you use Google OAuth, we receive your
            basic profile information.
          </p>
          <p>
            <strong>Media Data:</strong> We store the media items you track (movies, books, games,
            etc.), your ratings, journal entries, and activity logs. This data is the core of the
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>
              Process transactions and send related information (if you subscribe to a paid tier).
            </li>
          ...
          <p>
            <strong>We do not sell your personal data.</strong> Your media history and journal
            entries are private by default. We may share information with third-party service
            providers (such as hosting, payment processors like Stripe, and email delivery services
            like Resend) solely to provide our service.
          </p>

          <h2 className="text-2xl font-semibold text-white mt-8">4. Data Retention and Deletion</h2>
          <p>
            We retain your data as long as your account is active. You can request to delete your
            account and all associated data at any time through your account settings or by
            contacting support.
          </p>
