...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Memora is a personal media journal for movies, anime, books, games, music and more. Organize, remember and rediscover everything you experience." },
      { name: "author", content: "Memora" },
      { name: "theme-color", content: "#0d0d14" },
      { property: "og:title", content: "Memora — Your personal media journal" },
