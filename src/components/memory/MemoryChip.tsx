  ...
  return (
    <span
      ...
      className={cn(
        ...
        "glass-subtle text-foreground/80 border border-foreground/[0.08] hover:bg-foreground/[0.1] transition-all duration-[140ms] active:scale-[0.98] hover:-translate-y-[1px]",
        className,
      )}
    >
