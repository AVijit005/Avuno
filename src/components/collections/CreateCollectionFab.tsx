...
export function CreateCollectionFab({ onClick }: { onClick: () => void }) {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.97 }}
      className="group glass-strong fixed bottom-24 right-6 z-50 flex items-center gap-2 overflow-hidden rounded-full pl-3 pr-3 py-3 text-sm font-medium shadow-[0_30px_60px_-20px_oklch(0_0_0/0.6)] md:bottom-10 md:right-10"
