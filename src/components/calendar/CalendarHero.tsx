        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <button
              onClick={onToday}
              disabled={isAtToday}
              className="glass-subtle grid h-9 w-9 place-items-center rounded-full hover:bg-foreground/5 transition-all duration-[140ms] hover:-translate-y-[1px] hover:shadow-md active:scale-[0.98] disabled:opacity-20 disabled:cursor-default disabled:hover:translate-y-0 disabled:active:scale-100"
              aria-label="Today"
            >
            ...
            <button
              ...
              className="glass-subtle grid h-9 w-9 place-items-center rounded-full hover:bg-foreground/5 transition-all duration-[140ms] hover:-translate-y-[1px] hover:shadow-md active:scale-[0.98]"
            ...
            <button
              ...
              className="glass-subtle grid h-9 w-9 place-items-center rounded-full hover:bg-foreground/5 transition-all duration-[140ms] hover:-translate-y-[1px] hover:shadow-md active:scale-[0.98] disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:active:scale-100"
