...
const MODES = [
  {
    ...
    label: "Movies",
    icon: Film,
    item: { id: "interstellar", title: "Interstellar", creator: "Christopher Nolan", runtime: "2h 49m", progress: 68, backdrop: "linear-gradient(135deg, #2e1e2a 0%, #4a2d3d 50%, #7a3d5c 100%)", poster: "linear-gradient(135deg, #2e1e2a 0%, #4a2d3d 50%, #7a3d5c 100%)" },
  ...
  },
  {
    ...
    label: "Anime",
    icon: Sparkles,
    item: { id: "one-piece", title: "One Piece", creator: "Eiichiro Oda", runtime: "Episode 1071", progress: 42, backdrop: "linear-gradient(135deg, #1a2e2d 0%, #164a4a 50%, #0f7a6f 100%)", poster: "linear-gradient(135deg, #1a2e2d 0%, #164a4a 50%, #0f7a6f 100%)" },
  ...
  },
  {
    ...
    label: "Books",
    icon: BookOpen,
    item: { id: "harry-potter", title: "Harry Potter and the Sorcerer's Stone", creator: "J.K. Rowling", runtime: "Page 342", progress: 55, backdrop: "linear-gradient(135deg, #2e2a1e 0%, #4a3d2d 50%, #7a5c3d 100%)", poster: "linear-gradient(135deg, #2e2a1e 0%, #4a3d2d 50%, #7a5c3d 100%)" },
  ...
  },
  {
    ...
    label: "Games",
    icon: Gamepad2,
    item: { id: "elden-ring", title: "Elden Ring", creator: "FromSoftware", runtime: "84 Hours", progress: 75, backdrop: "linear-gradient(135deg, #1a1e2e 0%, #16313e 50%, #0f5260 100%)", poster: "linear-gradient(135deg, #1a1e2e 0%, #16313e 50%, #0f5260 100%)" },
  ...
  },
  {
    ...
    label: "Music",
    icon: Music2,
    item: { id: "dark-side", title: "The Dark Side of the Moon", creator: "Pink Floyd", runtime: "Track 4", progress: 40, backdrop: "linear-gradient(135deg, #2e1a1a 0%, #4a2d2d 50%, #7a3d3d 100%)", poster: "linear-gradient(135deg, #2e1a1a 0%, #4a2d2d 50%, #7a3d3d 100%)" },
