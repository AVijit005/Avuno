            ...
            <div className="mt-8">
              ...
              <p className="mt-2 line-clamp-2 text-sm leading-relaxed text-muted-foreground transition-colors group-hover:text-white/80">
                {collection?.description ??
                  "A dynamic collection personalized to your tastes and recent activity."}
              </p>

              <div
                className="mt-5 flex items-center gap-2 text-xs font-medium uppercase tracking-widest transition-colors group-hover:text-white"
                style={{ color: accent }}
              >
                <span>Explore</span>
                <ArrowRight
