  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          aria-hidden
          className="absolute right-0 top-0 h-24 w-24 opacity-40 transition-opacity duration-[var(--dur-large)] ease-[var(--ease-out)] group-hover:opacity-100"
          style={{
            background: `radial-gradient(circle at top right, ${item.accent ?? "var(--primary)"}, transparent 70%)`,
          }}
        />
        {/* rating chip */}
